...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the Add collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code MyApi myApi = new MyApi(...);}
   *   {@code MyApi.Add.List request = myApi.add().list(parameters ...)}
   * </pre>
   *
  ...
  /**
   * The "add" collection of methods.
   */
  public class Add {

    /**
     * Create a request for the method "add.teacher".
     *
     * This request holds the parameters needed by the myApi server.  After setting any optional
     * parameters, call the {@link Teacher#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.jaicode.api.myApi.model.Teacher}
     * @return the request
     */
    public Teacher teacher(com.jaicode.api.myApi.model.Teacher content) throws java.io.IOException {
      Teacher result = new Teacher(content);
      initialize(result);
      return result;
    }

    public class Teacher extends MyApiRequest<com.jaicode.api.myApi.model.Message> {
       ...
       * parameters, call the {@link Teacher#execute()} method to invoke the remote operation. <p>
       * {@link
       * Teacher#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
       * be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @param content the {@link com.jaicode.api.myApi.model.Teacher}
       * @since 1.13
       */
      protected Teacher(com.jaicode.api.myApi.model.Teacher content) {
        super(MyApi.this, "POST", REST_PATH, content, com.jaicode.api.myApi.model.Message.class);
      }

      @Override
      public Teacher setAlt(java.lang.String alt) {
        return (Teacher) super.setAlt(alt);
      }

      @Override
      public Teacher setFields(java.lang.String fields) {
        return (Teacher) super.setFields(fields);
      }

      @Override
      public Teacher setKey(java.lang.String key) {
        return (Teacher) super.setKey(key);
      }

      @Override
      public Teacher setOauthToken(java.lang.String oauthToken) {
        return (Teacher) super.setOauthToken(oauthToken);
      }

      @Override
      public Teacher setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (Teacher) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public Teacher setQuotaUser(java.lang.String quotaUser) {
        return (Teacher) super.setQuotaUser(quotaUser);
      }

      @Override
      public Teacher setUserIp(java.lang.String userIp) {
        return (Teacher) super.setUserIp(userIp);
      }

      @Override
      public Teacher set(String parameterName, Object value) {
        return (Teacher) super.set(parameterName, value);
      }
    }
  ...
  public class SayHi extends MyApiRequest<com.jaicode.api.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.jaicode.api.myApi.model.MyBean.class);
